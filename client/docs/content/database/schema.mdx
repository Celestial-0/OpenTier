...
|---------------|----------|--------|
| [`sqlx-cli`](https://crates.io/crates/sqlx-cli) | `server/db/migrations/` | users, sessions, accounts, verification_tokens, password_reset_tokens, conversations, messages, documents, document_chunks, ingestion_jobs, chat_messages, user_memories, knowledge_submissions |
