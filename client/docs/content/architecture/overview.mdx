...
- **Single database**: both Rust and Python connect to the same PostgreSQL instance. All migrations are centralized in `server/db/migrations/` and managed by [`sqlx-cli`](https://crates.io/crates/sqlx-cli).
