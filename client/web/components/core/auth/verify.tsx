...
import { type AuthView } from "@/components/core/auth/constants"
...
export function VerifyView({
    ...
    const handleVerify = async () => {
        ...
        try {
            ...
            toast.error(isApiError(e) ? e.message : "Verification failed")
        } finally {
    ...
    const handleResend = async () => {
        ...
        try {
            ...
            toast.error(isApiError(e) ? e.message : "Failed to resend code")
        }
    }
