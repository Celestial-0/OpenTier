...
const FeatureCard = ({
    ...
    return (
        ...
        >
            ...
            {index < 4 && (
                <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-linear-to-t from-muted/50 to-transparent pointer-events-none" />
            )}
            {index >= 4 && (
